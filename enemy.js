class Enemy extends PhysicalObject {
    ...
    if (this.alive == false && this.pos.y >= height - 20) {
        ...
        if (now/10 < 30) {
            ...
            stroke(71, 31, 0);
            strokeWeight(1);
            ellipse(this.pos.x, this.pos.y-12, 8, 12); //head
            ellipse(this.pos.x+1, this.pos.y+12, 6, 12); //thorax
            ellipse(this.pos.x-1, this.pos.y, 10, 16); //abdomen
            //eyes
        ...
        function eyes(pos, type) {
            if (type == "OPEN") {
                ...
                ellipse(pos.x+3, pos.y-14, 5,6);
                fill(0);
                circle(pos.x-3, pos.y-13,2);
                circle(pos.x+3, pos.y-13,2);
                //eye lids
                fill(51,0,0);
                arc(pos.x-3, pos.y-14, 5, 6, PI+QUARTER_PI, (2*PI)+QUARTER_PI, OPEN);
                arc(pos.x+3, pos.y-14, 5, 6, PI-QUARTER_PI, -QUARTER_PI, OPEN);
            } else if (type == "DEAD") {
                fill(255);
                noStroke();
                ellipse(pos.x-3, pos.y-14, 5,6);
                ...
                stroke(0);
                strokeWeight(2);
                line(pos.x-4, pos.y-15, pos.x+5, pos.y-12);
                line(pos.x-4, pos.y-12, pos.x+5, pos.y-15);
